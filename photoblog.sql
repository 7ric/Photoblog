...
CREATE USER 'pentesterlab'@'localhost' IDENTIFIED BY 'pentesterlab';
GRANT ALL PRIVILEGES ON *.* TO 'pentesterlab'@'localhost' WITH GRANT OPTION;
FLUSH PRIVILEGES;
...
-- Dump completed on 2016-02-29 13:05:34
